...
public interface RepairDAO {
	...
	*/
	...
	// 插入设备维护表数据 调用mapper包repair.xml里的insertRepair配置 返回值0(失败),1(成功)
	public int insertRepair(Repair repair);

	// 更新设备维护表数据 调用mapper包repair.xml里的updateRepair配置 返回值0(失败),1(成功)
	public int updateRepair(Repair repair);

	// 按主键删除设备维护表数据 调用mapper包repair.xml里的deleteRepair配置 返回值0(失败),1(成功)
	...
	// 查询设备维护表全部数据 调用mapper包repair.xml里的getAllRepair配置 返回List<Repair>类型的数据
	...
	// 按主键查询设备维护表返回单一的Repair实例 调用mapper包repair.xml里的getRepairById配置
